...
class Restaurants extends StatefulWidget {
  const Restaurants({Key? key, required this.places}) : super(key: key);
  final List<LocationInfo> places;

  @override
  State<Restaurants>  createState() => _Restaurants();
...
class _Restaurants extends State<Restaurants>
{
  ...
  {
    super.initState();
    visitedList = List.generate(widget.places.length, (index) => 0);
    rating = List.generate(widget.places.length, (index) => 0);
  }
